...
let
  ...
  sources = {
    x86_64-linux = fetchurl {
      url = "https://downloads.cursor.com/production/c4730f7d93d787d9ab120af715999f0345ee5bc5/linux/x64/Cursor-${version}-x86_64.AppImage";
      hash = "sha256-0XyWON0VetR/ZFNEFR1A383FsHxu7eMRZHBODq3qeNY=";
    };
    aarch64-linux = fetchurl {
      url = "https://downloads.cursor.com/production/c4730f7d93d787d9ab120af715999f0345ee5bc5/linux/arm64/Cursor-${version}-aarch64.AppImage";
      hash = "sha256-n1TWk5suQcr4PVXLJRM6bycwxG8jXNZr9ZtR+uPD1NM=";
    };
