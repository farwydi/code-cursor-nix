...
let
  ...
  sources = {
    x86_64-linux = fetchurl {
      url = "https://downloads.cursor.com/production/6496ea8a068aebfcd21990e70ff522e9abf10c8c/linux/x64/Cursor-${version}-x86_64.AppImage";
      hash = "sha256-s8imHoVRcsKlCZbY2s3q6mi8Byb0+6V2bBP6DMFmFX8=";
    };
    aarch64-linux = fetchurl {
      url = "https://downloads.cursor.com/production/6496ea8a068aebfcd21990e70ff522e9abf10c8c/linux/arm64/Cursor-${version}-aarch64.AppImage";
      hash = "sha256-81qidiYmZrT4drvzEKMuebI6lOhc2o9jZtGD3lBWpLU=";
    };
