...
let
  ...
  sources = {
    x86_64-linux = fetchurl {
      url = "https://downloads.cursor.com/production/ae3a2b7231dd56194447fe4570dfdc61640b1e9a/linux/x64/Cursor-${version}-x86_64.AppImage";
      hash = "sha256-kB38QeH6+HK05tSift0Uk62Ob5x1Jwswp/yvVjwk6D8=";
    };
    aarch64-linux = fetchurl {
      url = "https://downloads.cursor.com/production/ae3a2b7231dd56194447fe4570dfdc61640b1e9a/linux/arm64/Cursor-${version}-aarch64.AppImage";
      hash = "sha256-qRO/cJB2wGCcEZoXQebxTJ8LCFWI25J4QN4uVh7qsVw=";
    };
